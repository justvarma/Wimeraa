...
function DevicesTab() {
  ...
  <select
    value={form.partCountType}
    onChange={e =>
      setForm(p => ({
        ...p,
        partCountType: e.target.value as any
      }))
    }
    className={selectCls}
  >
  ...
  return <div className="bg-white border rounded-xl p-4">
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-2 mb-3">
      ...
      <div className="md:col-span-2 grid grid-cols-1 sm:grid-cols-2 gap-2 rounded-lg border border-orange-200 bg-orange-50 p-3">
        <p className="sm:col-span-2 text-[10px] font-black text-orange-700 uppercase tracking-wider">Weight Per Part — Die Casting</p>
        <input type="number" min="0.001" step="0.001" value={weightAfterDieCastingKg} onChange={e => setWeightAfterDieCastingKg(e.target.value)} placeholder="After Die Casting (KG) *" className="border border-slate-300 rounded px-3 py-2 text-sm text-slate-900 placeholder:text-slate-400 bg-white" />
        <input type="number" min="0.001" step="0.001" value={weightAfterMachiningKg} onChange={e => setWeightAfterMachiningKg(e.target.value)} placeholder="Under Machining (KG) *" className="border border-slate-300 rounded px-3 py-2 text-sm text-slate-900 placeholder:text-slate-400 bg-white" />
      </div>
